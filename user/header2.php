        ...
        <div class="container position-relative" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="" class="navbar-brand">
                    <h1 class="m-0 display-5 text-white"><span class="text-primary">WORKERS </span>  WORLD</h1>
                </a>
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="profile.php" class="dropdown-item"><?php echo $_SESSION['uname'];?></a>
                                

                               
                                <a href="datepaysel.php" class="dropdown-item">My Payments</a>
                                <a href="viewbooking111.php" class="dropdown-item">Cancel Booking</a>
