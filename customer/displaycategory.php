...
{ $s=$info[$i]["img"];
		...
		?>		 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						...
						<img style="width:300; height:300" src=<?php echo BASE_URL."uploads/".$info[$i]["img"]; ?> alt=" " class="img-responsive" />
							<?php /*?> <h4>Deluxe Room</h4><?php */?>
                              <h4><?php echo $info[$i]["category_name"]?></h4> 
			...
			<a href="displayitems.php?id=<?= $info[$i]["category_id"]?>" >VIEW</a>
							</div>
						</div>
					</div>
				</div>
